# FamilySync Data Model

This document defines the complete data model for FamilySync, including TypeScript interfaces, Yjs document structure, and schema validation.
